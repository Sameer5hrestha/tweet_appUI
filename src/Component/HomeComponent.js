...
renderFooter() {
        return (
            <div>
                <Button label="Cancel"  onClick={() => this.onHide(false)} className="p-button-text" />
  ...
  <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
    <a className="dropdown-item" href="#" onClick={this.getUserTweet.bind(this)}>View MyTweet</a>
    <a className="dropdown-item" href="#"  onClick={this.getAllTweet.bind(this)}>View AllTweet</a>
    <a className="dropdown-item" href="#"  onClick={this.displayPasswordReset.bind(this)}>Reset Password</a>
    <a className="dropdown-item" href="#"  onClick={this.logout.bind(this)}><i class="pi pi-sign-out">&nbsp;logout</i></a>
  </div>
</div>
    ...
    <Dialog header="Post Tweet" onHide={() => this.onHide()} footer={this.renderFooter()} visible={this.state.showPostTweet} style={{ width: '50vw' }}>
