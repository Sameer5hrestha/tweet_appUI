...
handleReplyChange=(e)=>{
 ...
 <Dialog header="Reply Tweet" onHide={() => this.onHide()} footer={this.renderFooter("reply")} visible={this.state.showReplyTweet} style={{ width: '40vw' }}>
...
<br/><span>{this.state.message}</span><br/>
 <table className = "table table-striped ">
                   ...
                   <br/><input  placeholder="Enter Post" name="post" className="form-control"  
                        ...
                        <Dialog header="Update Tweet" onHide={() => this.onHide()} footer={this.renderFooter("update")} visible={this.state.showUpdateTweet} style={{ width: '50vw' }}>
                        <br/><input  placeholder="Enter Post" name="post" className="form-control"  
